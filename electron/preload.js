...
contextBridge.exposeInMainWorld('gsxTool', {
  ...
  gates: {
    ...
    onStatus: (listener) => subscribe('gate:status', listener),
    onReleased: (listener) => subscribe('gate:released', listener)
  },
  gsx: {
    ...
    startActivation: () => ipcRenderer.invoke('gsx:activate:start'),
  ...
  support: {
    ...
    messages: () => ipcRenderer.invoke('sponsor:messages')
  },
  feedback: {
